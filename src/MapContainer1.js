...
function MapContainer1() {
  ...
  const origins = [
    "Shyamal Cross Road, Shyamal, Ahmedabad, Gujarat, India",
    "Shivranjani Cross Road, Shyamal, Ahmedabad, Gujarat, India",
  ...
  const centers = [
    { lat: 23.0146, lng: 72.5306 },
    { lat: 23.0295, lng: 72.5299 },
    { lat: 23.0321, lng: 72.5251 },
    { lat: 23.030357, lng: 72.517845 },
    { lat: 23.0401, lng: 72.5315 },
  ];
  ...
  return (
    ...
    >
      ...
      <Box position="absolute" left={0} top={0} h="100%" w="100%">
        ...
        >
          {console.log("centers", centers[index])}
            ...
            <DirectionsRenderer
              ...
              options={{
                markerOptions: {
                  Icon: "http://image.ibb.co/bZ3wLn/origin.png",
                  desIcon:
                    "https://image.ibb.co/cLwp5n/678111_map_marker_256.png",
                },
              }}
            />
          )}
      ...
      >
        ...
        <HStack spacing={4} mt={4} justifyContent="space-between">
          ...
          <IconButton
            ...
            isRound
            onClick={() => {
              map.panTo(centers[index]);
              map.setZoom(15);
              console.log("centerscccc", centers[index]);
